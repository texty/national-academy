...
//                    div.html(d.name + "<br> <br> Загальне фінансування: " + d.sum + " тис. грн")
    ...
    //                .interpolate("basis")
        ...
        .attr("stroke-width", function(d) {
            if (d.perPerson > 115 && d.group === "технические" || d.perPerson > 115 && d.group === "социальные" || d.perPerson > 115 && d.group === "естественные науки" || d.perPerson > 80 && d.group === "гуманитарные") { return 0.5  }
            else { return 0 }
        });
